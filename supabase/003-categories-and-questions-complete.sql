-- Complete Categories and Questions Data Population
-- This file populates the database with all categories and questions from the application
...
-- =================================================================
-- DEFAULT QUESTIONS FOR ALL OTHER CATEGORIES
-- =================================================================

-- HALLWAY Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
...
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('21234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde2', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
...
('21234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde2', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
...
-- BEDROOM Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('31234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde3', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('31234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde3', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('31234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde3', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- LIVING ROOM Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('41234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde4', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('41234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde4', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('41234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde4', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- BATHROOM Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('51234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde5', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('51234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde5', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('51234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde5', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- OFFICE Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('61234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde6', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('61234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde6', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('61234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde6', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- DRESSING ROOM Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('71234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde7', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('71234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde7', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('71234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde7', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- DULAP Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('81234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde8', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('81234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde8', 'The door Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "pal", "label": "PAL", "description": "Particle board with melamine coating", "icon": "Square"}, {"id": "mdf-infoliat", "label": "MDF Infoliat", "description": "MDF with foil wrapping", "icon": "Layers"}, {"id": "mdf-vopsit", "label": "MDF Vopsit", "description": "Painted MDF finish", "icon": "Paintbrush"}]'::jsonb, 2, 'ro'),

('81234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde8', 'The method of Opening', NULL, 'cards', 'single', true, NULL,
'[{"id": "push-to-open", "label": "Push to Open", "description": "Touch to open mechanism", "icon": "Hand"}, {"id": "maner", "label": "Maner", "description": "Traditional handles", "icon": "Grab"}]'::jsonb, 3, 'ro');

-- OUTSIDE FURNITURE Questions
INSERT INTO request_questions (id, category_id, question_text, description, question_type, selection_type, required, measurements_config, options, sort_order, lang_code) VALUES
('91234567-89ab-cdef-0123-456789abcde1', '01234567-89ab-cdef-0123-456789abcde9', 'Rough measurements', 'Provide the dimensions for your furniture', 'measurements', 'single', true,
'{"fields": [{"id": "length", "label": "Length", "required": true}, {"id": "width", "label": "Width", "required": true}, {"id": "height", "label": "Height", "required": true}], "units": ["m", "cm", "mm"], "defaultUnit": "cm"}'::jsonb, NULL, 1, 'ro'),

('91234567-89ab-cdef-0123-456789abcde2', '01234567-89ab-cdef-0123-456789abcde9', 'The Material', NULL, 'cards', 'multiple', true, NULL,
'[{"id": "teak", "label": "Teak", "description": "Durable teak wood for outdoor use", "icon": "TreePine"}, {"id": "aluminum", "label": "Aluminum", "description": "Weather-resistant aluminum", "icon": "Square"}, {"id": "rattan", "label": "Rattan", "description": "Natural rattan weaving", "icon": "Layers"}]'::jsonb, 2, 'ro'),

('91234567-89ab-cdef-0123-456789abcde3', '01234567-89ab-cdef-0123-456789abcde9', 'Weather Protection', NULL, 'cards', 'single', true, NULL,
'[{"id": "covered", "label": "Covered Area", "description": "Under roof or covered area", "icon": "Home"}, {"id": "uncovered", "label": "Uncovered Area", "description": "Direct exposure to weather", "icon": "Cloud"}]'::jsonb, 3, 'ro');

-- =================================================================
-- UPDATE KITCHEN QUESTIONS WITH SPECIFIC CONFIGURATIONS
-- =================================================================
